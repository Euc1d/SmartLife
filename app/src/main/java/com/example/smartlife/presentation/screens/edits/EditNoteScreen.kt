            ...
            Scaffold(
                        ...
                        actions = {
                            Icon(
                                modifier = Modifier
                                    .padding(end = 16.dp)
                                    .clickable {
                                        viewModel.processCommand(EditNoteCommand.Delete(id = noteId))
                                    },
                ...
                Column(modifier = Modifier.padding(innerPadding)) {
                    ...
                    Text(
                        ...
                        text = DateFormatter.formatDateTimeToString(currentState.note.updatedAt),
                    ...
                    Button(
                        ...
                        onClick = { viewModel.processCommand(EditNoteCommand.Save) },
